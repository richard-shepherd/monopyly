...
class VSSmartBuyerHighCostFocusAI(PlayerAIBase):
    '''
    '''
    def __init__(self):
        '''
        ...
        self.properties_information = {
            ...
            Square.Name.WHITECHAPEL_ROAD:       [300, 1, 1, 1, 250, 5, 0.75],
            #light blue
            Square.Name.THE_ANGEL_ISLINGTON:    [300, 1, 1, 1, 250, 4, 0.75],
            Square.Name.EUSTON_ROAD:            [300, 1, 1, 1, 250, 4, 0.75],
            Square.Name.PENTONVILLE_ROAD:       [300, 1, 1, 1, 250, 5, 0.75],
            #rose
            ...
            #yellow
            Square.Name.LEICESTER_SQUARE:       [0, 1.25, 1.25, 1.5, 50, 9, 0.75],
            Square.Name.COVENTRY_STREET:        [0, 1.25, 1.25, 1.5, 50, 9, 0.75],
            Square.Name.PICCADILLY:             [0, 1.3, 1.3, 1.65, 0, 10, 0.75],
            #green
            Square.Name.REGENT_STREET:          [0, 1.25, 1.25, 1.5, 50, 9, 0.75],
            Square.Name.OXFORD_STREET:          [0, 1.25, 1.25, 1.5, 50, 9, 0.75],
            Square.Name.BOND_STREET:            [0, 1.3, 1.3, 1.65, 0, 10, 0.75],
            #dark blue
            Square.Name.PARK_LANE:              [0, 1.25, 1.25, 1.5, 50, 9, 0.75],
            Square.Name.MAYFAIR:                [0, 1.3, 1.3, 1.65, 0, 10, 0.75],
            #station
            Square.Name.KINGS_CROSS_STATION:        [100, 1.5, 1.5, 1.5, 0, -1, 0],
            Square.Name.MARYLEBONE_STATION:         [100, 1.5, 1.5, 1.5, 0, -1, 0],
            Square.Name.FENCHURCH_STREET_STATION:   [100, 1.5, 1.5, 1.5, 0, -1, 0],
            Square.Name.LIVERPOOL_STREET_STATION:   [100, 1.5, 1.5, 1.5, 0, -1, 0],
            #company
            Square.Name.ELECTRIC_COMPANY:           [150, 1, 1, 1.25, 0, -1, 0.5],
            Square.Name.WATER_WORKS:                [150, 1, 1, 1.25, 0, -1, 0.5],
        }

    def get_name(self):
        return 'VSSmartBuyerHighCostFocusAI'

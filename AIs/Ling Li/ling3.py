...
class Ling3AI(LingAI):
    ...
    def __init__(self):
        ...
        self.properties_we_like = self.property_mortgage_list
    ...
    def property_offered_for_auction(self, game_state, player, property):
        ...
        '''
        #return super.property_offered_for_auction(game_state, player, property)
        return super(LingAI, self).property_offered_for_auction(game_state, player, property)

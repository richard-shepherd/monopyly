...
class LordMelchittAI(monopyly.PlayerAIBase) :
    '''
    A cunning AI
    '''
    ...
    def _SetEminentDomainStrategy(self):
        if self._player.state.cash > max(self._GetOtherPlayersCash()) :
            self._EminentDomainAuction = self._EminentDomainAuctionStrategy2
            self._eminentDomainAuctionHighPriceFactor = 0.8 # bid price is this factor * my cash if I really want it
            self._eminentDomainAuctionLowPriceFactor = 2    # bid price is this factor * prop price if I don't really want it
        else :
            self._EminentDomainAuction = self._EminentDomainAuctionStrategy1
            self._eminentDomainAuctionHighPriceFactor = 0.95
            self._eminentDomainAuctionLowPriceFactor = 0.2

...
class PercyAI(monopyly.PlayerAIBase) :
    '''
    A cunning AI
    '''
    ...
    def _SetEminentDomainStrategy(self):
        ...
        self._eminentDomainAuctionHighPriceFactor = 0.6 # bid price is this factor * my cash if I really want it
        self._eminentDomainAuctionLowPriceFactor = 1   # bid price is this factor * prop price if I don't really want it
